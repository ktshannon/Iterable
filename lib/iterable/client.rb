...
module Iterable
  class Client
    ...
    # List Postbacks must be enabled by Iterable
    ...
    #  returns:
    #   hash, response from server
    # Request various stats from Iterable.
    def get_stats(stat)
    ...
    #   options, Hash
    #
    # Push a new piece of content to Iterable, triggering any applicable alerts.
    # http://docs.Iterable.com/api/content
